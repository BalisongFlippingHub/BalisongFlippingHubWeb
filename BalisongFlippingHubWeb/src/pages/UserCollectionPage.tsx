        ...
        <section className="w-full h-full flex flex-col">
            ...
            <section className="w-full border-b-4 border-black p-4 flex justify-between">
                ...
                <div className="flex gap-3">
                    <div className="rounded-full w-36 h-36 border overflow-hidden hover:cursor-pointer" onClick={() => navigate("/me")}>
                        <Image imageId={user?.profileImg!} />
                    </div>

                    <div className="hover:cursor-pointer place-self-center" onClick={() => navigate("/me")}>
            ...
            <section className="w-full h-full flex sm:flex-col md:flex-row">
                ...
                {
                    !collection || !collection?.ownedKnives || collection?.ownedKnives.length === 0
                    ?
