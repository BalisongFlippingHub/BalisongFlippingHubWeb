        ...
        <div className="md:h-5/6 sm:h-auto flex items-center xsm:flex-col-reverse md:flex-row">
          <div className="md:w-2/3 sm:w-full flex flex-col justify-center p-8 text-center md:h-full sm:h-auto">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-6">
                Welcome to the Balisong Flipping Hub! The community center for
                entusiest about balisong flipping, collecting, modding and more!
                Make a name for yourself, display your flipping clips, post your
                personal balisongs, put your modding buisness out there or show
              ...
              <button
                ...
                className="bg-black p-3 rounded mt-2 hover:bg-shadow-green-offset"
              >
                Community
