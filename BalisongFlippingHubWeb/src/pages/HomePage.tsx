        ...
        <div>
            <section className="h-screen">
                <div className="h-full w-full">
                    <h2 className="w-full h-1/6 text-3xl bg-teal-700 font-bold text-center pt-32 pl-36">Balisong Flipping Hub</h2>
                    <div className="flex h-5/6">
                        <div className="w-1/2 flex flex-col justify-center pl-44 pr-5 items-center">
                            ...
                            <div className="flex">
                                ...
                                <div className="p-4 flex flex-col items-center w-1/2">
                                    <p className="text-center">Want to check out the available prodcucts or looking for info on a specific knife?</p>
                        ...
                        <div className="w-1/2 flex flex-col items-center justify-center">
                            <h3 className="">Place Holder for auto display and site data</h3>
                        </div>
                    </div>
                </div>
            </section>
