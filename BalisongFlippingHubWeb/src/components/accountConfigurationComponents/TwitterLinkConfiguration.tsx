...
const TwitterLinkConfiguration = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!value.startsWith("https://www.x.com")) {
      setIsError(true);
      setErrorMsg("Link must be a Twitter link");
      return;
    }
    ...
    await axiosApiInstanceAuth
      .request({
        url: "accounts/me/update-twitter-link",
        method: "post",
        data: { newLink },
      })
      .then((res) => {
  ...
  return (
    ...
    >
      <p className="text-lg">Link your Twitter account.</p>
      ...
      <div className="w-full flex">
        ...
        {user?.twitterLink === newLink ||
        !newLink.startsWith("https://www.x.com") ? (
          <button
            type="submit"
...
export default TwitterLinkConfiguration;
