...
const UserProfilePostComponent = () => {
            ...
            <ul className="flex text-lg font-semibold">
                {
                    activeNavItem === "All"
                    ?
                    <li className="p-2 border-r border-l hover:cursor-pointer bg-teal-500" onClick={() => setActiveNavItem("All")}>All</li>
                    :
                ...
                }
                {
                    ...
                    ?
                    <li className="p-2 border-r hover:cursor-pointer bg-teal-500" onClick={() => setActiveNavItem("Sell/Trade")}>Sell/Trade</li>
                    :
                ...
                }
                {
                    ...
                    ?
                    <li className="p-2 border-r hover:cursor-pointer bg-teal-500" onClick={() => setActiveNavItem("Flipping")}>Flipping</li>
                    :
                ...
                }
                {
                    ...
                    ?
                    <li className="p-2 border-r hover:cursor-pointer bg-teal-500" onClick={() => setActiveNavItem("Show Off")}>Show Off</li>
                    :
                ...
                }
                {
                    ...
                    ?
                    <li className="p-2 border-r hover:cursor-pointer bg-teal-500" onClick={() => setActiveNavItem("Collection")}>Collection</li>
                    :
                ...
                }
                {
                    activeNavItem === "Misc."
                    ?
                    <li className="p-2 border-r hover:cursor-pointer bg-teal-500" onClick={() => setActiveNavItem("Misc.")}>Misc.</li>
                    :
...
export default UserProfilePostComponent;