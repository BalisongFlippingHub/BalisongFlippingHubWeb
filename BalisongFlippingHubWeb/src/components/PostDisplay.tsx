    ...
    if (isLoading) {
        ...
        return (
            ...
            <div className="flex justify-between p-2 border-b-2 border-shadow-green-offset">
                ...
                <div className="flex">
                    <div className="rounded-full w-12 h-12 overflow-hidden hover:cursor-pointer" onClick={navigateToUsersPage}>
                        <ProfileImgDisplay imgStr={postData?.creatorProfileImg}/>
                    </div>
                    <div className="ml-2">
                        <h3 className="text-2xl hover:cursor-pointer" onClick={navigateToUsersPage}>{postData?.creatorName}</h3>
            ...
            <div className="flex flex-col">
                {
                    ...
                    <div className="flex mb-1 p-2">
                        <h3 className="bg-shadow-green-offset p-2 rounded-full">{postData?.identifier}</h3>
                    </div>
                }
