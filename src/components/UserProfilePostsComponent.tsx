  ...
  return (
    <div className="w-full flex flex-col mt-5 text-white">
      ...
      <ul className="flex text-lg font-semibold m-auto">
        {activeNavItem === "All" ? (
          <li
            className="p-2 border-r border-l hover:cursor-pointer bg-shadow-green-offset"
          ...
          <li
            className="p-2 border-r border-l hover:cursor-pointer"
            onClick={() => setActiveNavItem("All")}
          >
            All
          </li>
        ...
        {activeNavItem === "Sell/Trade" ? (
          <li
            className="p-2 border-r hover:cursor-pointer bg-shadow-green-offset"
            onClick={() => setActiveNavItem("Sell/Trade")}
          >
            Sell/Trade
          </li>
        ) : (
          <li
            className="p-2 border-r hover:cursor-pointer"
            onClick={() => setActiveNavItem("Sell/Trade")}
          >
            Sell/Trade
          </li>
        ...
        {activeNavItem === "Flipping" ? (
          <li
            className="p-2 border-r hover:cursor-pointer bg-shadow-green-offset"
            onClick={() => setActiveNavItem("Flipping")}
          >
            Flipping
          </li>
        ) : (
        ...
        {activeNavItem === "Show-Off" ? (
          <li
            className="p-2 border-r hover:cursor-pointer bg-shadow-green-offset"
            onClick={() => setActiveNavItem("Show-Off")}
          >
            Show-Off
          </li>
        ) : (
        ...
        {activeNavItem === "Collection" ? (
          <li
            className="p-2 border-r hover:cursor-pointer bg-shadow-green-offset"
            onClick={() => setActiveNavItem("Collection")}
          >
            Collection
          </li>
        ) : (
        ...
        {activeNavItem === "Mod-Work" ? (
          <li
            className="p-2 border-r hover:cursor-pointer bg-shadow-green-offset"
            onClick={() => setActiveNavItem("Mod-Work")}
          >
            Mod-Work
          </li>
        ) : (
      ...
      {/*Display Posts*/}
      <div className="w-full flex flex-wrap mt-5">{getPostsCovers()}</div>
    </div>
  );
};
