...
const CollectionBannerComponent = () => {
  ...
  if (isFullScreen) {
    ...
    return (
      <div className="w-full xsm:h-28 md:h-40 lg:h-48 backdrop-filter backdrop-blur-lg bg-opacity-30 bg-blue-primary border-b rounded-b-3xl">
            ...
            {isLoading ? (
              ...
              <div className="relative w-full h-full">
                <button
                  ...
                  className="absolute md:right-6 xsm:right-4 xsm:bottom-3 md:bottom-6 md:text-xl xsm:text-sm text-white font-bold bg-dark-primary md:p-4 xsm:p-2 rounded-lg outline-none hover:shadow-lg hover:shadow-black hover:bg-black hover:scale-110 transition-all ease-in-out duration-300"
                >
                  {windowSize.at(1)! < 950 ? (
                    <div>
